...
export default function AboutPopover() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button type="button" onClick={() => setOpen((o) => !o)} className="flex h-10 w-10 items-center justify-center rounded-lg border border-zinc-700/50 bg-zinc-900/80 text-zinc-400 hover:bg-zinc-700 hover:text-white transition-colors cursor-pointer backdrop-blur-sm" title="About checkRent" data-tour-id="about">
